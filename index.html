...
<head>
    <meta charset="UTF-8">
    <title>Welcome to Davendra</title>
    <!--Style Starts-->
            ...
            <div class="header-container">
                    ...
                    <div class="logo-name">
                        ...
                        <div class="name">
                            <a href="index.html" title="">
                                <h5>Er. Davendra Kumar Sharma</h5>
                                <h5 class="primary-color">Aligarh</h5>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="header-links">
                    <a href="#" data-toggle="popover" title="Address"
                       data-content="VPO- Karanpur, Tehsil- Gabhana, Aligarh (Uttar Pradesh) Pin Code-202142"
                       data-placement="bottom"><i class="fa fa-map-marker fa-lg" aria-hidden="true"></i></a>

                    <a href="#" data-toggle="popover" title="Phone No." data-content="+91-84-45488271"
                       data-placement="bottom"><i class="fa fa-phone fa-lg" aria-hidden="true"></i></a>

                    <a href="#" data-toggle="popover" title="Email" data-content="davendragpm@gmail.com"
                       data-placement="bottom"><i class="fa fa-envelope fa-lg" aria-hidden="true"></i></a>
                        </div>
              </div>
            
                <div id="first"><div class="collapse navbar-collapse" id="myNavbar">
    </div>
    <nav>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="exam/index.php">Test Series</a></li>
    ...
    <div class="carousel-wrapper">
        <div class="carousel" style="margin: 0 auto">
           <div class="carousel-items">
                <img height="400px" src="img/gallery/photo6.jpg" alt="Photo6">
                <div></div>
            </div>
            <div class="carousel-items">
                <img height="400px" src="img/gallery/photo5.jpg" alt="Photo5">
                <div></div>
            </div>
            <div class="carousel-items">
                <img height="400px" src="img/gallery/photo4.jpg" alt="Photo4">
                <div></div>
            </div>
            <div class="carousel-items">
                <img height="400px" src="img/gallery/photo3.jpg" alt="Photo3">
                <div></div>
            </div>
            <div class="carousel-items">
                <img height="400px" src="img/gallery/photo2.jpg" alt="Photo2">
                <div></div>
            </div>
            <div class="carousel-items">
                <img height="400px" src="img/gallery/photo_1.jpg" alt="Photo1">
                <div></div>
            </div>
        </div>
    </div>
    ...
    <div class="widgets-wrapper">
        <div class="widgets-container">
            ...
            <div class="alert alert-warning text-center">
                 Does not click on <a class="alert-link" href="https://paytm.me/h-pS1C8">Link</a>
            </div>
            ...
            <div class="col-sm-4" id="announcements">
                <div class='announcement-content '>
                    ...
                    <ul id="announcement-list">
                        ...
                        <li>
                            For queries related to <b>Web Page </b>contact us at: &nbsp; &nbsp; <span
                                style="font-size: 12px; font-weight: bold;color:Black"><a
                                href="mailto:davendragpm@gmail.com">davendragpm@gmail.com</a></span>
                        </li>
                    </ul>
                    ...
                    <ul id="events-list">
                        <li>
                            <div class="event-container">
                                ...
                                <!-- Event-Description -->
                                <div class="event-text">Birth Day</div>
                            </div>
                        </li>
                    </ul>
            ...
            <div class="col-sm-4" id="news">
                <div class='news-content '>
                    ...
                    <ul id="news-list">
                        <li>
                            <a href="https://elearning.iirs.gov.in/edusatregistration/student" target="_blank">ISRO</a> free online course with certificate
        ...
        <div class="footer-wrapper">
            ...
            <div class="row">
                <div class="col-sm-4 address">
                    <strong>Address : </strong>VPO- Karanpur, Tehsil- Gabhana, Aligarh (Uttar Pradesh) Pin Code-202142
                </div>
                ...
                <div class="col-sm-4 footer-social">
                    <a href="https://www.facebook.com/davendrakumar.sharma.37"><i class="fa fa-facebook" aria-hidden="true" title="Official Facebook Page"></i></a>
                    <a href="https://wa.me/message/PW2377FSTDSBB1"><i class="fa fa-whatsapp" aria-hidden="true"
                                                          title="whatsapp Contect"></i></a>
